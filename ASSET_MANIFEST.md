...
| 164 | `capture-dramatic-spritesheet` | `public/assets/animations/capture-dramatic-spritesheet.png` | `animation-sheet` | Five-cell dramatic arrest strip: two running poses for the disguised culprit, two right-facing running poses for the pursuing federal agents and one right-to-left prisoner escort pair. | `320x64` | `transparent` | `GLOBAL_SHARED` | `IMPLEMENTED` |
