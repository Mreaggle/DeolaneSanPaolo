...
export const preloadGroups = {
  ...
  case: ['AIRPLANE_TRAVEL', 'HOT_TRAIL', 'COLD_TRAIL', 'SUSPICIOUS_HENCHMAN', 'CULPRIT_VERY_CLOSE', 'TIME_ALMOST_EXPIRED', 'CRIME_COMPUTER_CALCULATING', 'WARRANT_ISSUED', 'WARRANT_INCONCLUSIVE', 'FINAL_CITY', 'WRONG_FINAL_HIDEOUT', 'CRIMINAL_REVEALED', 'CRIMINAL_ESCAPED', 'CASE_CLOSED', 'RANK_PROMOTION'],
